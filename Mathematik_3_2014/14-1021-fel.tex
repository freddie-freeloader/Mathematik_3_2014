...
\begin{enumerate}
	...
	%
	ist Gruppe bezüglich $\odot$ (vgl. Bemerkung \ref{bem1.16}) mit Ordnung $\abs{Z_n^*}=\varphi(n)$ (''phi von $n$'', Eulersche $\varphi$-Funktion) = Anzahl aller $z \in \N$, die teilerfremd zu $n$ sind und $1 \leq z \leq n$.
