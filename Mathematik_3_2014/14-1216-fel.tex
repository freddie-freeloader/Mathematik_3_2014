...
Jedes solche $x$ heißt dann ein za $lambda$ geh``origer \emph{Eigenvektor} von $A$ und $\Eig(\lambda)=\Eig_A(\lambda)=\{x \in K^n | Ax=\lambda\}$ (alle zu $lambda$ geh''or. EV \& der Nullvektor $\zerovec$) der $\lambda$ zugeordnete $\emph{Eigenraum}$.
